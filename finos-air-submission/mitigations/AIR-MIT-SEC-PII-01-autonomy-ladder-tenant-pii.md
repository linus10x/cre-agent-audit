...
reference_implementation: "https://github.com/linus10x/cre-agent-audit/blob/main/src/cre_agent_audit/governance/tenant_pii_partition.py"
...
Reference Python implementation at `src/cre_agent_audit/governance/tenant_pii_partition.py`. MIT-licensed.
