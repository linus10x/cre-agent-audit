...
Examples in commercial real estate: a rent-pricing AI recommends prices across owners in the same market in a way that creates the antitrust-coordination surface the U.S. v. RealPage matter (DOJ + 8 state AGs, filed August 23, 2024; Sherman Act §§ 1 and 2; resolved by DOJ proposed consent judgment Nov 24, 2025, pending Tunney Act approval, never adjudicated) alleged. A tenant-screening AI scores housing-voucher applicants negatively in violation of the Fair Housing Act (the SafeRent failure mode, approximately $2.275M class settlement, November 2024).
...
**Severity: Critical.** Each named example above carries either a settled-case precedent ($15M TransUnion · approximately $2.275M SafeRent · DOJ Sherman Act §§ 1 and 2 action against RealPage, resolved by proposed consent judgment Nov 24, 2025 pending Tunney Act approval) or a binding regulatory standard (FINRA position limits · board-approved VaR). The cost of an unmitigated failure is measured in millions per incident.
...
- U.S. v. RealPage, Inc. et al. (DOJ + 8 state AGs, filed August 23, 2024; Sherman Act §§ 1 and 2 — DOJ filed a proposed consent judgment with RealPage Nov 24, 2025, pending Tunney Act approval; co-defendant final judgments entered, e.g., Greystar Mar 2, 2026; resolved without admission of liability, never adjudicated)
